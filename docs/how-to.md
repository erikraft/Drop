...
1. Download the latest _erikraftdrop-cli.zip_ from the [releases page](https://github.com/erikraft/Drop/releases/)
   ```shell
   wget "https://github.com/erikraft/Drop/releases/download/v1.11.7/erikraftdrop-cli.zip"
   ```
   or
   ```shell
   curl -LO "https://github.com/erikraft/Drop/releases/download/v1.11.7/erikraftdrop-cli.zip"
   ```
