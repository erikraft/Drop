...
Show this help text:	erikraft-drop (-h|--help)
...
1. Download the latest _erikraftdrop-cli.zip_ from the [releases page](https://github.com/erikraft/Drop/releases)
   ```shell
   wget "https://github.com/erikraft/Drop/releases/download/v1.11.2/erikraftdrop-cli.zip"
   ```
   or
   ```shell
   curl -LO "https://github.com/erikraft/Drop/releases/download/v1.11.2/erikraftdrop-cli.zip"
   ```
...
3. Inside this folder, copy the file _.erikraft-cli-config.example_ to _.erikraftdrop-cli-config_
...
4. Copy the shortcut _send with ErikraftDrop.lnk_
