---
title: "How-To Guides"
description: "Step-by-step guides for using ErikrafT Drop on different platforms"
icon: "book"
---
...
7. Click _New_, insert the preferred folder (`C:\Program Files\erikraftdrop-cli`), click _OK_ until all windows are closed
