...
description: "Common questions and answers about ErikrafT Drop"
...
<details>
  ...
  [https://www.cdc.gov/niosh/mining/tools/installpwa.html](https://www.cdc.gov/niosh/mining/tools/installpwa.html)
  ...
  **Android** \
  ...
  2. Click *Install* on the installation pop-up or use the three-dot-menu and click on *Add to Home screen*
...
<details>
  ...
  <br /> [https://routinehub.co/shortcut/24753/](https://routinehub.co/shortcut/24753/) <br /> (Official ErikrafT Drop Shortcut)

  Update: \
  Apparently, this was only a bug that is fixed in recent iOS version ([https://github.com/WebKit/WebKit/pull/13111](https://github.com/WebKit/WebKit/pull/13111)). \
...
[**https://crowdin.com/project/erikraft-drop**](https://crowdin.com/project/erikraft-drop)
