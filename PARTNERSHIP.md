...
* Include a white `.svg` version sized at **40×40**.
* **Optional:** If you would like your partnership to be displayed with a custom **Client** icon (similar to `docs/client.png`), submit a simplified all-white `.svg` version specifically designed for use as the Client badge. If accepted, this icon may be used throughout the Drop project to represent your organization.
